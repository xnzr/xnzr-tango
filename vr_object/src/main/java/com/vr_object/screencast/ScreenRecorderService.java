package com.vr_object.screencast;
/*
...
import com.vr_object.fixed.WiFiAugmentedRealityActivity;
...
public class ScreenRecorderService extends Service {
	...
	private static final String APP_DIR_NAME = "xnzr-screen-recording";
    static {
    	//FileUtils.DIR_NAME = APP_DIR_NAME;
    }

	private static final String BASE = "com.vr_object.screencast.ScreenRecorderService.";
					...
					try {
						...
						if (true) {
							...
							new MediaScreenEncoder(sMuxer, mMediaEncoderListener,
									projection, width, height, metrics.densityDpi, -1, 15);
						}
						if (true) {
							// for audio capturing
...
//================================================================================
	...
	protected PendingIntent createPendingIntent() {
		return PendingIntent.getActivity(this, 0, new Intent(this, WiFiAugmentedRealityActivity.class), 0);
	}
